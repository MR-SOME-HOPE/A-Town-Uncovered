...
## Setup
## Story Path
label lbl_restaurant_day_setup:
    ...
    ## NO EVENTS
        ...
        jump lbl_restaurant_day

###############
## Room Navigation
## This is the map for restaurant during the day
label lbl_restaurant_day:
    scene bg restaurant_day
    call screen scr_restaurant_day

screen scr_restaurant_day():
    imagebutton auto "btn restaurant_day_door_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_restaurant_day_door")
