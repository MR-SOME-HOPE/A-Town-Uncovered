...
label lbl_janae_plowed_over_boxes_revisit:
    ## PRE STORY
    ...
    jump lbl_janae_plowed_over_boxes_revisit_0

label lbl_janae_plowed_over_boxes_revisit_0:
    # if hscene_xray == 0:
    #     jump lbl_janae_plowed_over_boxes_revisit_1
    # else:
    #     jump lbl_janae_plowed_over_boxes_revisit_1_0
...
####################
## Stage 1
label lbl_janae_plowed_over_boxes_revisit_1:
    scene img_janae_plowed_over_boxes_stage_1
    if skill_sta <= 7:
        $ renpy.pause(10,hard=True)
        jump lbl_janae_plowed_over_boxes_revisit_menu
    elif skill_sta <= 14:
        $ renpy.pause(15,hard=True)
        jump lbl_janae_plowed_over_boxes_revisit_2
...
####################
## Stage 2
label lbl_janae_plowed_over_boxes_revisit_2:
    ...
    if skill_sta <= 14:
        ...
        $ renpy.pause(20,hard=True)
        jump lbl_janae_plowed_over_boxes_revisit_3
...
####################
## Stage 3
label lbl_janae_plowed_over_boxes_revisit_3:
...
####################
## Cum
label lbl_janae_plowed_over_boxes_revisit_menu:
    call screen scr_janae_plowed_over_boxes_revisit_menu

screen scr_janae_plowed_over_boxes_revisit_menu():
    imagebutton auto "btn hscene_continue_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_janae_plowed_over_boxes_revisit_0")
    imagebutton auto "btn hscene_cum_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_janae_plowed_over_boxes_revisit_cum")

label lbl_janae_plowed_over_boxes_revisit_cum:
    ...
    menu:
        "Cum inside":
            ...
            pov "Mhmm- okay-"
            jump lbl_janae_plowed_over_boxes_revisit_cumin

        "Cum outside":
            jan "Oh shit- um pull out!"
            jan "I'm not on any pills."
            pov "Mhmm- okay-"
            jump lbl_janae_plowed_over_boxes_revisit_cumout

####################
## CUM IN
label lbl_janae_plowed_over_boxes_revisit_cumin:
...
####################
## CUM OUT
label lbl_janae_plowed_over_boxes_revisit_cumout:
