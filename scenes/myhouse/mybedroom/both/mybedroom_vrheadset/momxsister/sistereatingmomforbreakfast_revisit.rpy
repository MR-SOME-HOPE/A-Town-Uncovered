...
label lbl_sister_eating_mom_for_breakfast_revisit:
...
label lbl_sister_eating_mom_for_breakfast_revisit_licking:
    show bg sistereatingmomforbreakfast_12
    ...
    if sistereatingmomforbreakfast_counter >= 10:
        ...
        jump lbl_sister_eating_mom_for_breakfast_revisit_licking
