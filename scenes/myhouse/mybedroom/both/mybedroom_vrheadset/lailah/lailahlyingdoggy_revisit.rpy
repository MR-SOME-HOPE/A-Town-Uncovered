## Lailah Lying Doggy
label lbl_lailah_lying_doggy_revisit:
    ## PRE STORY

label lbl_lailah_lying_doggy_revisit_0:
    if hscene_xray == 0:
        jump lbl_lailah_lying_doggy_revisit_1
    else:
        jump lbl_lailah_lying_doggy_revisit_1_0

####################
## Doggy Stage 1
label lbl_lailah_lying_doggy_revisit_1:
    scene img_lailah_lying_doggy_stage_1
    if skill_sta <= 7:
        $ renpy.pause(10,hard=True)
        jump lbl_lailah_lying_doggy_revisit_menu
    elif skill_sta <= 14:
        $ renpy.pause(15,hard=True)
        jump lbl_lailah_lying_doggy_revisit_2
...
####################
## Doggy Stage 1 XRAY
label lbl_lailah_lying_doggy_revisit_1_0:
    ...
    if skill_sta <= 7:
        ...
        $ renpy.pause(15,hard=True)
        jump lbl_lailah_lying_doggy_revisit_2_0
...
####################
## Doggy Stage 2
label lbl_lailah_lying_doggy_revisit_2:
    ...
    if skill_sta <= 14:
        ...
        $ renpy.pause(20,hard=True)
        jump lbl_lailah_lying_doggy_revisit_3
...
####################
## Doggy Stage 2 XRAY
label lbl_lailah_lying_doggy_revisit_2_0:
    ...
    if skill_sta <= 14:
        ...
        $ renpy.pause(20,hard=True)
        jump lbl_lailah_lying_doggy_revisit_3_0
...
####################
## Doggy Stage 3
label lbl_lailah_lying_doggy_revisit_3:
...
####################
## Doggy Stage 3 XRAY
label lbl_lailah_lying_doggy_revisit_3_0:
...
####################
## Doggy Cum
label lbl_lailah_lying_doggy_revisit_menu:
    call screen scr_lailah_lying_doggy_revisit_menu

screen scr_lailah_lying_doggy_revisit_menu():
    imagebutton auto "btn hscene_continue_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_lailah_lying_doggy_revisit_0")
    imagebutton auto "btn hscene_cum_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_lailah_lying_doggy_revisit_cum")

label lbl_lailah_lying_doggy_revisit_cum:
    lai "Just come inside me!"
    lai "I want it inside me!"
    lai "It's okay, [povname]!"

    if hscene_xray == 0:
        jump lbl_lailah_lying_doggy_revisit_cumin
    else:
        jump lbl_lailah_lying_doggy_revisit_cumin_0

####################
## Doggy Cum In
label lbl_lailah_lying_doggy_revisit_cumin:
...
####################
## Doggy Cum In XRAY
label lbl_lailah_lying_doggy_revisit_cumin_0:
    scene bg lailahlyingdoggy_14
    $ renpy.pause(1.5,hard=True)
