...
default hitomi_livingroomdoggy = 0

label lbl_hitomi_livingroom_doggy:
    ## PRE STORY

label lbl_hitomi_livingroom_doggy_0:
    #$ hitomi_livingroom_doggy_counter = 0
    if hscene_xray == 0:
        jump lbl_hitomi_livingroom_doggy_1
    else:
        jump lbl_hitomi_livingroom_doggy_1_0

####################
## Stage 1
label lbl_hitomi_livingroom_doggy_1:
    scene img_hitomi_livingroom_doggy_stage_1
    if skill_sta <= 7:
        $ renpy.pause(10,hard=True)
        jump lbl_hitomi_livingroom_doggy_menu
    elif skill_sta <= 14:
        $ renpy.pause(15,hard=True)
        jump lbl_hitomi_livingroom_doggy_2
...
image img_hitomi_livingroom_doggy_stage_1:
...
####################
## Stage 1 XRAY
label lbl_hitomi_livingroom_doggy_1_0:
    scene img_hitomi_livingroom_doggy_stage_1_0
    if skill_sta <= 7:
        $ renpy.pause(10,hard=True)
        jump lbl_hitomi_livingroom_doggy_menu
    elif skill_sta <= 14:
        $ renpy.pause(15,hard=True)
        jump lbl_hitomi_livingroom_doggy_2_0
...
image img_hitomi_livingroom_doggy_stage_1_0:
...
####################
## Stage 2
label lbl_hitomi_livingroom_doggy_2:
    scene img_hitomi_livingroom_doggy_stage_2
    if skill_sta <= 14:
        $ renpy.pause(15,hard=True)
        jump lbl_hitomi_livingroom_doggy_menu
        ...
        $ renpy.pause(20,hard=True)
        jump lbl_hitomi_livingroom_doggy_3

    else:
        $ renpy.pause(10,hard=True)
        jump lbl_hitomi_livingroom_doggy_2

image img_hitomi_livingroom_doggy_stage_2:
...
####################
## Stage 2 XRAY
label lbl_hitomi_livingroom_doggy_2_0:
    scene img_hitomi_livingroom_doggy_stage_2_0
    if skill_sta <= 14:
        $ renpy.pause(15,hard=True)
        jump lbl_hitomi_livingroom_doggy_menu
        ...
        $ renpy.pause(20,hard=True)
        jump lbl_hitomi_livingroom_doggy_3_0

    else:
        $ renpy.pause(10,hard=True)
        jump lbl_hitomi_livingroom_doggy_2_0

image img_hitomi_livingroom_doggy_stage_2_0:
...
####################
## Stage 3
label lbl_hitomi_livingroom_doggy_3:
    scene img_hitomi_livingroom_doggy_stage_3
    if skill_sta <= 20:
        $ renpy.pause(20,hard=True)
        jump lbl_hitomi_livingroom_doggy_menu
...
image img_hitomi_livingroom_doggy_stage_3:
...
####################
## Stage 3 XRAY
label lbl_hitomi_livingroom_doggy_3_0:
    scene img_hitomi_livingroom_doggy_stage_3_0
    if skill_sta <= 20:
        $ renpy.pause(20,hard=True)
        jump lbl_hitomi_livingroom_doggy_menu
...
image img_hitomi_livingroom_doggy_stage_3_0:
...
####################
## Cum
label lbl_hitomi_livingroom_doggy_menu:
    call screen scr_hitomi_livingroom_doggy_menu

screen scr_hitomi_livingroom_doggy_menu():
    imagebutton auto "btn hscene_continue_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_hitomi_livingroom_doggy_0")
    imagebutton auto "btn hscene_cum_%s" xpos 0 ypos 0 focus_mask True action Jump("lbl_hitomi_livingroom_doggy_cumchoice")

label lbl_hitomi_livingroom_doggy_cumchoice:
    menu:
        "Cum inside":
            if hscene_xray == 0:
                jump lbl_hitomi_livingroom_doggy_cumin
            else:
                jump lbl_hitomi_livingroom_doggy_cumin_0
        "Cum on her":
            jump lbl_hitomi_livingroom_doggy_cumout

####################
## Cum In
label lbl_hitomi_livingroom_doggy_cumin:
    ...
    $ hitomi_livingroomdoggy = 0

    jump lbl_mylivingroom_day_setup

####################
## Cum In XRAY
label lbl_hitomi_livingroom_doggy_cumin_0:
...
####################
## Doggy Cum Out
label lbl_hitomi_livingroom_doggy_cumout:
